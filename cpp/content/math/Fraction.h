...
struct Q {
	...
	T gcd(T x, T y) const { return __gcd(x, y); } // switch if using BigInt
...
// comparison is completely safe, others are safer but still can overflow
template<typename T>
struct QO {
	T a, b;
	QO(T p, T q = 1) {
	...
	QO operator-(const QO &o) const { return *this + QO(-o.a, o.b); }
	QO operator*(const QO &o) const { 
		T g1 = gcd(a, o.b), g2 = gcd(o.a, b);
		return { (a / g1) * (o.a / g2), (b / g2) * (o.b / g1) };
	}
	QO operator/(const QO &o) const { return *this * QO(o.b, o.a); }
